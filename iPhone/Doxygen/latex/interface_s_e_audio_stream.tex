...
Close Stream \hypertarget{interface_s_e_audio_stream_aa20244d64005b2e198eb72f99d6f7bee}{\index{S\-E\-Audio\-Stream@{S\-E\-Audio\-Stream}!export\-To\-File\-:completion\-:@{export\-To\-File\-:completion\-:}}
\index{export\-To\-File\-:completion\-:@{export\-To\-File\-:completion\-:}!SEAudioStream@{S\-E\-Audio\-Stream}}
\subsubsection[{export\-To\-File\-:completion\-:}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (void) export\-To\-File\-: 
\begin{DoxyParamCaption}
\item[{(N\-S\-String $\ast$)}]{file\-Path}
\item[{completion:(void($^\wedge$)(N\-S\-Error $\ast${\bf error}))}]{completion}
\end{DoxyParamCaption}
}}\label{interface_s_e_audio_stream_aa20244d64005b2e198eb72f99d6f7bee}
